...
if (Player1_o.actionPoints <= 0){
	draw_set_color(c_orange);
	draw_text(37, 255, "EXHAUSTED");
	draw_set_color(c_white);
}
if (Player2_o.actionPoints <= 0){
	draw_set_color(c_orange);
	draw_text(1253, 255, "EXHAUSTED");
	draw_set_color(c_white);
}
draw_set_color(c_purple);
draw_text(37, 445, string(Player1_o.hungerLvlString));
draw_text(1253, 445, string(Player2_o.hungerLvlString));
draw_set_color(c_white);