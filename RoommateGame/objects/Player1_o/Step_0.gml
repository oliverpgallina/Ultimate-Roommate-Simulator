...
if (!regenerating && !relievingStress)
{
	...
	PlayerInteract(Player1_o, WorkTask_o, (!panicked && hungerLevel < 3 && BasicTask_o.player != Player2_o && actionPoints > 0) );
	PlayerInteract(Player1_o, StudyTask_o, (!panicked && hungerLevel < 3 && BasicTask_o.player != Player2_o && actionPoints > 0) );
	PlayerInteract(Player1_o, Trash_o, (!panicked && hungerLevel < 3 && Clock_o.trashLevel != 0 && BasicTask_o.player != Player2_o && actionPoints > 0) );
	PlayerInteract(Player1_o, Couch_o, ( !Player2_o.relievingStress && hungerLevel == 1 && BasicTask_o.player != Player2_o && actionPoints > 0) );
	PlayerInteract(Player1_o, Stove_o, (hungerLevel != 1 && BasicTask_o.player != Player2_o && actionPoints > 0) );
