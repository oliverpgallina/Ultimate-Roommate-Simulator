...
if(/*collision_circle(x, y, 70, Player1_o, true, true)*/ place_meeting(x,y, Player1_o) && keyboard_check(Player1_o.actionKey) 
&& Player1_o.canInteract && !Player1_o.regenerating && taskCanInteract) {
	player = Player1_o;
}
else if (/*collision_circle(x, y, 70, Player2_o, true, true)*/ place_meeting(x,y, Player2_o) && keyboard_check(Player2_o.actionKey) 
