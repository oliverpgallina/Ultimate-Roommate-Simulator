...
if(collision_circle(x, y, 70, Player1_o, true, true) && keyboard_check(Player1_o.actionKey) && Player1_o.canInteract) {
	player = Player1_o;
}
else if (collision_circle(x, y, 70, Player2_o, true, true) && keyboard_check(Player2_o.actionKey) && Player2_o.canInteract) {
	player = Player2_o;
}
else{
currValue = 0;
